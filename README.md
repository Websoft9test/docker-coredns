...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r coredns
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r coredns -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-coredns
cd docker-coredns
docker-compose  up -d
```
...
[CoreDNS Administrator Guide](https://support.websoft9.com/docs/coredns)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [CoreDNS Enterprise Support](https://apps.websoft9.com/coredns) 
